    ...
    <body class="page-header-fixed page-quick-sidebar-over-content page-header-fixed-mobile page-footer-fixed1">
        ...
        if ($cont == "home") {
            ...
            if ($view == "addAccountTitle" || $view == "deleteAccount" || $view == "editAccountInfo") {
                ...
                $account = $s . ' ' . $a;
                $transection = $a;
            } elseif ($view == "studentTranjection") {
                $account = $s . ' ' . $a;
                $studentTranjection = $a;
            } elseif ($view == "teacherCollection") {
                $account = $s . ' ' . $a;
                $teacherCollection = $a;
            } elseif ($view == "allSlips") {
                $account = $s . ' ' . $a;
                $allSlips = $a;
            } elseif ($view == "slipDetails") {
                $account = $s . ' ' . $a;
                $allSlips = $a;
            } elseif ($view == "editSlip") {
                $account = $s . ' ' . $a;
                $allSlips = $a;
            } elseif ($view == "deletSlipItem") {
                $account = $s . ' ' . $a;
                $allSlips = $a;
            } elseif ($view == "deletSlip") {
                $account = $s . ' ' . $a;
                $allSlips = $a;
            } elseif ($view == "slipAction") {
                $account = $s . ' ' . $a;
                $allSlips = $a;
            ...
            if ($view == "conWeeklyDay") {
                ...
                $configuration = $s . ' ' . $a;
                $messageSettings = $a;
            } elseif ($view == "setStuFee") {
                $configuration = $s . ' ' . $a;
                $accountSetting = $s . ' ' . $a;
                $setStuFee = $a;
            } elseif ($view == "configClassFee") {
                $configuration = $s . ' ' . $a;
                $accountSetting = $s . ' ' . $a;
                $setStuFee = $a;
            } elseif ($view == "editClassFee") {
                $configuration = $s . ' ' . $a;
                $accountSetting = $s . ' ' . $a;
                $setStuFee = $a;
                        ...
                        <?php } if ($this->common->user_access('add_account_title', $userId) || $this->common->user_access('fee_collection', $userId) || $this->common->user_access('all_slips', $userId) || $this->common->user_access('trensection', $userId) || $this->common->user_access('pay_salary', $userId) || $this->common->user_access('own_slip', $userId)) { ?>
                            <li class="nav-item <?php echo $account; ?>">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <?php } if ($this->common->user_access('fee_collection', $userId)) { ?>
                                        <li class="nav-item <?php echo $studentTranjection; ?>">
                                            <a href="index.php/account/studentTranjection" class="nav-link ">
                                                <span class="title"><?php echo lang('header_cre_stu_pay'); ?></span>
                                            </a>
                                        </li>
