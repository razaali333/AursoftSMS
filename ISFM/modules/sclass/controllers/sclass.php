...
class Sclass extends MX_Controller {
    ...
    public function deleteClass() {
        ...
        if ($this->db->delete('clas_info', array('id' => $id))) {
            if ($this->db->delete('class', array('id' => $classId))) {
    ...
    public function ownClassRoutin() {
        ...
        $query = $this->db->query("SELECT * FROM class_students WHERE user_id='$userId'");
    ...
    public function promotion() {
        if ($this->input->post('submit', TRUE)) {
            ...
            if ($this->classmodel->chFiExRe($classTitle)) {
                $examId = $this->classmodel->chFiExRe($classTitle);
                ...
                foreach ($query->result_array() as $row) {
                    ...
                    if ($status == 'Pass') {
                        ...
                        $arrayClassStud = array(
                            ...
                            'class_title' => $this->db->escape_like_str($nextClass),
                            'section' => $this->db->escape_like_str($section),
                        ...
                        if ($this->db->update('class_students', $arrayClassStud)) {
                            ...
                            $this->db->where('class_title', $nextClass);
                            $this->db->update('clas_info', $arrayClassInfo);
                            ...
                            $arrayParentsInfo = array(
                                'student_class' => $this->db->escape_like_str($nextClass)
                            );
                            $this->db->where('student_id', $studentId);
