                                                ...
                                                foreach ($query as $row4) {
                                                    ...
                                                    <?php if($this->common->user_access('rutin_edit_delete',$userId)){ ?>
                                                                <div class="info">
                                                                    ...
                                                                    <a class="btn btn-xs red buttonMargin" href="index.php/sclass/deleteRoutine?id=<?php echo $row4['id']; ?>&class=<?php echo $class_id; ?>" onClick="javascript:return confirm('Are you sure you want to delete this subject from this Class routine?')"> <i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?> </a>
                                                                </div>
                                                    <?php } ?>
                                                        </div>
                                                    </div>
